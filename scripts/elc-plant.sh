...
#
# Lives in this transport tree (not latproc). Typical use after a rebuild:
#   ./scripts/elc-plant.sh status
#   ./scripts/elc-plant.sh setup
#
# Usage:
...
#
# Override: ELC_SRC=…  PREFIX=…  IOD_SVC=…  ELC_CYCLE_CPU=…  ELC_CYCLE_FIFO_PRIORITY=…

set -euo pipefail

# Source tree = parent of scripts/ unless ELC_SRC is set.
